...
albums = [
    ...
    {"genre": "Musique française", "artist": "M. Pokora",
    ...
    {"genre": "Chanson française", "artist": "Francis Cabrel",
    ...
    {"genre": "Chanson française", "artist": "Georges Brassens",
        "album": "Les Copains d’abord"},
    {"genre": "Chanson française", "artist": "Serge Gainsbourg",
        "album": "Histoire de Melody Nelson"},
    {"genre": "Chanson française", "artist": "Barbara", "album": "L’aigle noir"},
    {"genre": "Chanson française", "artist": "Michel Sardou",
    ...
    {"genre": "Chanson française", "artist": "Michel Delpech",
    ...
    {"genre": "Rock français", "artist": "No One Is Innocent",
        "album": "Revolution.com"},
    {"genre": "Rock français", "artist": "Dionysos",
        "album": "Western sous la neige"},
    {"genre": "Rock français", "artist": "Shaka Ponk",
        "album": "The Geeks and the Jerkin' Socks"},
    {"genre": "Rock français", "artist": "Astonvilla", "album": "Live"},
    {"genre": "Rock français", "artist": "Eiffel",
        "album": "Le quart d’heure des ahuris"},
    {"genre": "Rock français", "artist": "Kaolin",
        "album": "De retour dans nos criques"},
    ...
    {"genre": "Musique française", "artist": "Pierre Lapointe",
        "album": "La science du cœur"},
    {"genre": "Musique française", "artist": "Cœur de pirate", "album": "Roses"},
    {"genre": "Musique française", "artist": "Salvatore Adamo",
        "album": "Mes chansons italiennes"},
...
for album in albums:
    ...
    album_folder = os.path.join(root_dir, year_range, sanitize_filename(
        genre), sanitize_filename(album_title) + f"-artist-{sanitize_filename(artist)}")
    os.makedirs(album_folder, exist_ok=True)

    print(
        f"  -> Album trouvé (MBID: {mbid}, Année: {release_year}). Récupération des titres...")
